...
export async function GET(request: NextRequest) {
  ...
  // The /*turbopackIgnore: true*/ comment tells Turbopack not to trace this
  // dynamic filesystem path at build time — it is only resolved at runtime.
  const localBase = path.join(/*turbopackIgnore: true*/ process.cwd(), '..', iosPath);
